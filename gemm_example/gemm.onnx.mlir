...
#map2 = affine_map<(d0) -> (-d0 + 10000)>
#map3 = affine_map<(d0) -> (-d0 + 10000, 32)>
#map4 = affine_map<(d0) -> (d0)>
#map5 = affine_map<(d0) -> (d0 + 64)>
#map6 = affine_map<(d0) -> (d0 + 32, 10000)>
#map7 = affine_map<(d0, d1) -> (d1 - d0)>
#map8 = affine_map<(d0, d1, d2, d3, d4) -> (d4 - d3)>
#map9 = affine_map<(d0) -> (d0 + 1)>
#map10 = affine_map<(d0) -> (d0 + 2)>
#map11 = affine_map<(d0) -> (d0 + 3)>
#set = affine_set<(d0, d1, d2, d3, d4) : (1 >= 0, 1 >= 0, 1 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<10000x9216xf32>, %arg1: memref<9216x128xf32>) -> memref<10000x128xf32> attributes {input_names = ["X1", "X2"], llvm.emit_c_interface, output_names = ["Y"]} {
    ...
    affine.for %arg2 = 0 to 128 step 64 {
      affine.for %arg3 = 0 to 9216 step 256 {
        %c256 = arith.constant 256 : index
        %c64 = arith.constant 64 : index
        %c9216_6 = arith.constant 9216 : index
        ...
        affine.for %arg4 = 0 to 256 {
          affine.for %arg5 = 0 to 64 {
            ...
            %2 = affine.load %arg1[%0, %1] : memref<9216x128xf32>
        ...
        affine.for %arg4 = 0 to 10000 step 32 {
          ...
          %c9216_12 = arith.constant 9216 : index
          %c1_13 = arith.constant 1 : index
          %c1_14 = arith.constant 1 : index
          %c0_15 = arith.constant 0 : index
          %0 = affine.apply #map2(%arg4)
          %1 = affine.min #map3(%arg4)
          affine.for %arg5 = 0 to min #map3(%arg4) {
            affine.for %arg6 = 0 to 256 {
              %2 = affine.apply #map(%arg4, %arg5)
              %3 = affine.apply #map1(%arg4, %arg5, %arg3, %arg6)
              %4 = affine.load %arg0[%2, %3] : memref<10000x9216xf32>
              affine.store %4, %alloc_4[%arg5, %arg6] : memref<32x256xf32>
            }
          }
          affine.for %arg5 = #map4(%arg2) to #map5(%arg2) step 16 {
            affine.for %arg6 = #map4(%arg4) to min #map6(%arg4) step 4 {
              ...
              %c9216_25 = arith.constant 9216 : index
              %c1_26 = arith.constant 1 : index
              %2 = affine.apply #map7(%arg4, %arg6)
              %c0_27 = arith.constant 0 : index
              %c0_28 = arith.constant 0 : index
              %3 = affine.apply #map8(%arg4, %arg6, %arg3, %arg2, %arg5)
              ...
              affine.if #set(%arg4, %arg6, %arg3, %arg2, %arg5) {
                ...
                %5 = arith.addi %c0_36, %arg5 : index
                %6 = vector.load %alloc[%4, %5] : memref<10000x128xf32>, vector<16xf32>
                affine.store %6, %alloca[%c0] : memref<4xvector<16xf32>>
                %7 = affine.apply #map9(%c0)
                %8 = arith.addi %7, %arg6 : index
                %9 = arith.addi %c0_36, %arg5 : index
                %10 = vector.load %alloc[%8, %9] : memref<10000x128xf32>, vector<16xf32>
                affine.store %10, %alloca[%7] : memref<4xvector<16xf32>>
                %11 = affine.apply #map10(%c0)
                %12 = arith.addi %11, %arg6 : index
                %13 = arith.addi %c0_36, %arg5 : index
                %14 = vector.load %alloc[%12, %13] : memref<10000x128xf32>, vector<16xf32>
                affine.store %14, %alloca[%11] : memref<4xvector<16xf32>>
                %15 = affine.apply #map11(%c0)
                %16 = arith.addi %15, %arg6 : index
                %17 = arith.addi %c0_36, %arg5 : index
                %18 = vector.load %alloc[%16, %17] : memref<10000x128xf32>, vector<16xf32>
                affine.store %18, %alloca[%15] : memref<4xvector<16xf32>>
                affine.for %arg7 = 0 to 256 step 4 {
                  %34 = arith.addi %c0, %2 : index
                  %35 = arith.addi %arg7, %c0_27 : index
                  %36 = memref.load %alloc_4[%34, %35] : memref<32x256xf32>
                  %37 = vector.broadcast %36 : f32 to vector<16xf32>
                  %38 = arith.addi %arg7, %c0_28 : index
                ...
                %20 = arith.addi %c0, %arg6 : index
                %21 = arith.addi %c0_36, %arg5 : index
                vector.store %19, %alloc[%20, %21] : memref<10000x128xf32>, vector<16xf32>
                %22 = affine.apply #map9(%c0)
                %23 = affine.load %alloca[%22] : memref<4xvector<16xf32>>
                %24 = arith.addi %22, %arg6 : index
                %25 = arith.addi %c0_36, %arg5 : index
                vector.store %23, %alloc[%24, %25] : memref<10000x128xf32>, vector<16xf32>
                %26 = affine.apply #map10(%c0)
                %27 = affine.load %alloca[%26] : memref<4xvector<16xf32>>
                %28 = arith.addi %26, %arg6 : index
                %29 = arith.addi %c0_36, %arg5 : index
                vector.store %27, %alloc[%28, %29] : memref<10000x128xf32>, vector<16xf32>
                %30 = affine.apply #map11(%c0)
                %31 = affine.load %alloca[%30] : memref<4xvector<16xf32>>
                %32 = arith.addi %30, %arg6 : index
                %33 = arith.addi %c0_36, %arg5 : index
                vector.store %31, %alloc[%32, %33] : memref<10000x128xf32>, vector<16xf32>
              } else {
              }
            }
          }
